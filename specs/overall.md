...
Built incrementally, one endpoint/feature per spec. `specs/001-rest-api-endpoints.md` covers `GET /surveys/active`; remaining rows below are unimplemented / future specs.
